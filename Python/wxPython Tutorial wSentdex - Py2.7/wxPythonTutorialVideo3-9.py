...
class windowClass(wx.Frame):
    ...
    def basicGUI(self):
        ...
        quitToolButton = toolBar.AddLabelTool(wx.ID_ANY, 'Quit',
                                              wx.Bitmap('toolquit.jpg'))

        #importToolButton = toolBar.AddLabelTool(wx.ID_ANY, 'Import',
        #                                        wx.Bitmap('import.png'))
        # if desired, this is how you would add another button.
        ...
        exitItem.SetBitmap(wx.Bitmap('sadface.jpg'))
        ...
        wx.TextCtrl(panel, pos=(3, 150), size=(300,150))
