...
class Feedback:
    ...
    def __init__(self, master):
        ...
        # When you are saving variables, you don't want to call the grid methods
        # directly on the widgets, rather call them on the variables after the
    ...
    def submit(self):
        ...
        # If this were a 'live project' this would either collect this data to store
        # it in a database or perhaps send the information to an email address.
