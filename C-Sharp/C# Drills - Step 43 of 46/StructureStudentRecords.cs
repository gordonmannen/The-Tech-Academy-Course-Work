...
namespace StructureStudentRecords
{
    class Program
    {
        ...
        static void update(student[] st, int itemcount)
        {
            ...
            else Console.WriteLine("The record deosn't exist.Check the ID and try again.");
        ...
        static void find(student[] st, int itemcount)
        {
            ...
            else Console.WriteLine("The record doesn't exist.");
